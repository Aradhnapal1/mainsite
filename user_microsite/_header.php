...
<head>
    ...
    <script>
        window.MICROSITE_API_BASE = <?php echo json_encode($micrositeApiBase); ?>;
        window.MICROSITE_CONTEXT = {
            micrositeId: <?php echo json_encode($activeMicrositeId); ?>,
...
<header class="ms-header py-3 mb-4">
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-2">
        <a href="index.php<?php echo htmlspecialchars($msQuery, ENT_QUOTES, 'UTF-8'); ?>" class="text-decoration-none d-flex align-items-center text-reset">
