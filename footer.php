                ...
                <div class=" col-lg-4">
                    <div class="widget widget-about">
                        <img src="assets/images/demos/demo-7/logo1.png" class="footer-logo" alt="Footer Logo"
                            width="200" height="25">
                        <p>Secure shopping, fast checkout, trusted payments, timely delivery, reliable customer support.
                        </p>
                                ...
                                <div class="tab-pane fade show active" id="signin" role="tabpanel"
                                    ...
                                    <form action="#" id="loginForm">
                                        ...
                                        <div class="form-footer">
                                            ...
                                            <a href="forgot-password.php" class="forgot-link" id="forgotPasswordLink"
                                                title="Reset main site account password">Forgot Your Password?</a>
                                        </div><!-- End .form-footer -->
                                    </form>
                                    ...
                                    <form action="#" id="registerForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="register-last-name"
                                                name="register-last-name" required>
                                        </div>
...
<script>(function () { function c() { var b = a.contentDocument || a.contentWindow.document; if (b) { var d = b.createElement('script'); d.innerHTML = "window.__CF$cv$params={r:'9f3bf5e90af38b7f',t:'MTc3NzQ0MTEwNw=='};var a=document.createElement('script');a.src='../../cdn-cgi/challenge-platform/h/b/scripts/jsd/0b8fb825cb67/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);"; b.getElementsByTagName('head')[0].appendChild(d) } } if (document.body) { var a = document.createElement('iframe'); a.height = 1; a.width = 1; a.style.position = 'absolute'; a.style.top = 0; a.style.left = 0; a.style.border = 'none'; a.style.visibility = 'hidden'; document.body.appendChild(a); if ('loading' !== document.readyState) c(); else if (window.addEventListener) document.addEventListener('DOMContentLoaded', c); else { var e = document.onreadystatechange || function () { }; document.onreadystatechange = function (b) { e(b); 'loading' !== document.readyState && (document.onreadystatechange = e, c()) } } } })();</script>
</body>


<!-- Mirrored from portotheme.com/html/molla/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Apr 2026 05:39:24 GMT -->
