...
<main class="main">
    <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        <div class="container">
            <h1 class="page-title">Our Collection<span>Shop</span></h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
            ...
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="products mb-3">
                        <div class="row justify-content-center" id="productRow">
                            <!-- Products loaded by product.js -->
                        </div><!-- End .row -->
                    </div><!-- End .products -->
                ...
                <aside class="col-lg-3 order-lg-first">
                    <div class="sidebar sidebar-shop">
                        <div class="widget widget-clean" style="display: flex; align-items: center;">
                            <label style="margin: 0;">Filters:</label>
                            <div id="active-filter-tags" style="display: flex; flex-wrap: wrap; gap: 5px; flex: 1; margin: 0 10px;"></div>
                            <a href="#" class="sidebar-filter-clear" style="white-space: nowrap;">Clean All</a>
                            ...
                            <div class="collapse show" id="widget-1">
                                <div class="widget-body">
                                    <div class="filter-items filter-items-count">
                                        <div class="filter-item" id="categoryFilter"></div>
                                    </div>
                                </div><!-- End .widget-body -->
                            </div><!-- End .collapse -->
                        </div><!-- End .widget -->
                        ...
                        <div class="widget widget-collapsible">
                            ...
                            <div class="collapse show" id="widget-2">
                                <div class="widget-body">
                                    <div class="filter-items" id="sizeFilter">
                        ...
                        <div class="widget widget-collapsible">
                            ...
                            <div class="collapse show" id="widget-3">
                                <div class="widget-body">
                                    <div class="filter-colors" id="colorFilter">
                        ...
                        <div class="widget widget-collapsible">
                            ...
                            <div class="collapse show" id="widget-4">
                                <div class="widget-body">
                                    <div class="filter-items" id="brandFilter">
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
