        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">All blog</div>
                    </li>
                </ul>
            </div>
            <!-- all-category -->
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href="new-blog.php"><i class="icon-plus"></i>Add Blog</a>
                </div>
                <div class="wg-table table-all-attribute">
                    <ul class="table-title flex gap20 mb-14">
                        ...
                        <li style="flex: 0 0 150px;">
                            <div class="body-title"> Blog Name</div>
                        </li>
                        <li style="flex: 1;">
                    ...
                    <ul class="flex flex-column" id="blogTableBody">
                        <!-- Dynamic blog list will load here -->
                    </ul>
                </div>
