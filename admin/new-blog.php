...
<div class="main-content">
    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" id="addBlogForm">

                    <!-- Brand Name -->
                    <fieldset class="name">
                        <div class="body-title">
                               Blog Name <span class="tf-color-1">*</span>
                        </div>
                        <input class="flex-grow" type="text" placeholder="Blog name" name="text" required>
                    </fieldset>

                    <!-- textarea -->
                    <fieldset class="name">
                        <div class="body-title">
                               Blog description <span class="tf-color-1">*</span>
                        </div>
                        <textarea class="flex-grow" placeholder="Blog description" name="description" required></textarea>
                    </fieldset>
                    ...
                    <fieldset class="category">
                        <div class="body-title">Blog Status</div>
